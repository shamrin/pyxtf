...
| Версия | Изменения |
|--------|-----------|
| 0.7.0  | При экспорте в SEG-Y теперь используются поля `ship_xcoordinate` и `ship_ycoordinate` (вместо `sensor_xcoordinate` и `sensor_ycoordinate`). См. также стр. 24 стандарта XTF (XTFPINGHEADER, байты 128, 136, 160 и 168).|
