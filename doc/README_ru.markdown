...
*Замечание:* Не рекомендуется в одном проекте смешивать файлы с различающимися номерами каналов. Могут возникнуть проблемы при пакетном преобразовании файлов. В версии 0.6.1 была исправлена связанная с этим ошибка (подробности ниже).
